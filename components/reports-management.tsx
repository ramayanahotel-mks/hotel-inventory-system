...
export function ReportsManagement({
  ...
  const generateReportData = () => {
    ...
    switch (reportType) {
      case "items":
        data = filterDataByDate(items, "createdAt")
        headers = [
          "id",
          "code",
          "name",
        ...
        break
      case "transactions":
        data = filterDataByDate(transactions, "date").map((t) => {
        ...
        break
      case "depreciations":
        data = filterDataByDate(depreciations, "date").map((d) => {
        ...
        break
      case "suppliers":
        data = filterDataByDate(suppliers, "createdAt")
        headers = ["id", "code", "name", "contact", "phone", "email", "address", "status", "createdAt"]
        filename = "laporan_supplier.csv"
        break
      case "users":
        data = filterDataByDate(users, "lastLogin") // Assuming lastLogin as a relevant date field for users
